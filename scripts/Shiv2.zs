...
<simpledifficulty:wool_helmet:*>.addTooltip(format.darkRed("+2 温暖"));
<simpledifficulty:wool_chestplate:*>.addTooltip(format.darkRed("+2 温暖"));
<simpledifficulty:wool_leggings:*>.addTooltip(format.darkRed("+2 温暖"));
<simpledifficulty:wool_boots:*>.addTooltip(format.darkRed("+2 温暖"));
<simpledifficulty:ice_helmet:*>.addTooltip(format.darkAqua("+2 降温"));
<simpledifficulty:ice_chestplate:*>.addTooltip(format.darkAqua("+2 降温"));
<simpledifficulty:ice_leggings:*>.addTooltip(format.darkAqua("+2 降温"));
<simpledifficulty:ice_boots:*>.addTooltip(format.darkAqua("+2 降温"));

<rlmixins:scarlite_helmet:*>.displayName = "\u00A74\u00A7k赤铁\u00A7r\u00A74 头盔";
<rlmixins:scarlite_chestplate:*>.displayName = "\u00A74\u00A7k赤铁\u00A7r\u00A74 胸甲";
<rlmixins:scarlite_leggings:*>.displayName = "\u00A74\u00A7k赤铁\u00A7r\u00A74 护腿";
<rlmixins:scarlite_boots:*>.displayName = "\u00A74\u00A7k赤铁\u00A7r\u00A74 靴子";

<mujmajnkraftsbettersurvival:itemsteelhammer:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<mujmajnkraftsbettersurvival:itemsteelspear:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<mujmajnkraftsbettersurvival:itemsteeldagger:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<mujmajnkraftsbettersurvival:itemsteelbattleaxe:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<mujmajnkraftsbettersurvival:itemsteelnunchaku:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:dagger_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:longsword_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:katana_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:saber_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:rapier_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:greatsword_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:hammer_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:warhammer_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:spear_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:throwing_axe_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:halberd_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:pike_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:lance_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:throwing_knife_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:javelin_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:boomerang_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:battleaxe_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:mace_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:glaive_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
<spartanweaponry:staff_steel:*>.addTooltip(format.gold("+2 对下界生物和火元素的伤害"));
...
//<mujmajnkraftsbettersurvival:itemwoodnunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemstonenunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemironnunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemdiamondnunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemgoldnunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itembronzenunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemsilvernunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemsteelnunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemdragonbonenunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemjunglechitinnunchaku:*>.addTooltip(format.green("连续攻击"));
//<mujmajnkraftsbettersurvival:itemdesertchitinnunchaku:*>.addTooltip(format.green("连续攻击"));

//<mujmajnkraftsbettersurvival:itemwooddagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemstonedagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemirondagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemdiamonddagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemgolddagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itembronzedagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemsilverdagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemsteeldagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemdragonbonedagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemjunglechitindagger:*>.addTooltip(format.green("背刺加成"));
//<mujmajnkraftsbettersurvival:itemdesertchitindagger:*>.addTooltip(format.green("背刺加成"));

//<mujmajnkraftsbettersurvival:itemwoodbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemstonebattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemironbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemdiamondbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemgoldbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itembronzebattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemsilverbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemsteelbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemdragonbonebattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemjunglechitinbattleaxe:*>.addTooltip(format.green("缴械几率"));
//<mujmajnkraftsbettersurvival:itemdesertchitinbattleaxe:*>.addTooltip(format.green("缴械几率"));

//<mujmajnkraftsbettersurvival:itemwoodspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemstonespear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemironspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemdiamondspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemgoldspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itembronzespear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemsilverspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemsteelspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemdragonbonespear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemjunglechitinspear:*>.addTooltip(format.green("增加范围,可投掷"));
//<mujmajnkraftsbettersurvival:itemdesertchitinspear:*>.addTooltip(format.green("增加范围,可投掷"));

//<mujmajnkraftsbettersurvival:itemwoodhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemstonehammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemironhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemdiamondhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemgoldhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itembronzehammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemsilverhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemsteelhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemdragonbonehammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemjunglechitinhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));
//<mujmajnkraftsbettersurvival:itemdesertchitinhammer:*>.addTooltip(format.green("次要攻击,眩晕和击退"));

<sereneseasons:greenhouse_glass:*>.addTooltip(format.green("允许作物在任何季节下7格直接下方生长"));
