    ...
    if ((event.player.world.canSeeSky(event.position)) && (blockLight <= 7)) {
        ...
        if (event.player.world.random.nextFloat(0, 100) <= BadNightChance) {
            ...
            if ((randomNum <= TerrorChance) && !(event.player.world.getBlockState(posOne).causesSuffocation)) {
                ...
                event.player.sendStatusMessage("从黑暗中爬出，从天空中俯瞰……", true);
                ...
                event.player.sendStatusMessage("不祥的气息从阴暗的天空中悄然蔓延……", true);
            ...
            event.player.sendStatusMessage("在黑暗的天空下，你感到不安，渐渐进入梦乡", true);
        ...
        if (event.player.world.random.nextFloat(0, 100) <= BadNightChance) {
            ...
            if ((randomNum <= TerrorChance) && !(event.player.world.getBlockState(posOne).causesSuffocation)) {
                ...
                event.player.sendStatusMessage("他们从天而降......", true);
                ...
                event.player.sendStatusMessage("你感觉仿佛天空睁开了眼睛...", true);
            ...
            event.player.sendStatusMessage("在开阔的天空下，你感到不安，但至少附近有光源……", true);
        ...
        if (event.player.world.random.nextFloat(0, 100) <= BadNightChance) {
            ...
            if ((randomNum <= TerrorChance) && !(event.player.world.getBlockState(posOne).causesSuffocation)) {
                ...
                event.player.sendStatusMessage("他们从黑暗中来......", true);
                ...
                event.player.sendStatusMessage("有什么东西从黑暗中注视着你......", true);
            ...
            event.player.sendStatusMessage("天色已暗，但总比暴露在外要好", true);
